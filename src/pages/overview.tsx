  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-4xl">
        <h1 className="text-2xl font-bold text-center mb-6">Feedback-Paar-Generator</h1>

        {/* Teilnehmer */}
        <div>
          <h2 className="text-lg font-semibold mb-2">Teilnehmer:</h2>
          <p>Namen aller Teilnehmer (ein Name je Zeile)</p>
          <textarea
        ...
        {rounds.length > 0 && (
          <div>
            <h2 className="text-lg font-semibold mb-2">Feedback Paare je Runde:</h2>
            {rounds.map((round, index) => (
              <div key={index} className="mb-2">
                <h3 className="text-md font-semibold">Runde {index + 1}</h3>
                <p>Feedback Paare aus Runde {index + 1} der Form 'Name1, Name2' (ein Paar je Zeile)</p>
        ...
        <div className="flex flex-col content-center mb-4">
          <h2 className="text-lg font-semibold mb-2">Aktionen:</h2>
        ...
        {/* Bestehende Daten */}
        <div className="mb-4">
          <h2 className="text-lg font-semibold mb-2">Bestehende Daten:</h2>
          <p className="mb-4">Nachfolgend können die bestehenden Feedback-Paare aus Runde 1-4 geladen werden:</p>
